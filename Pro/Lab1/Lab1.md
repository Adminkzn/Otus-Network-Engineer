...
| Site | VLAN | Purpose | Virtual IP | Active Router | Active IP | Standby Router | Standby IP |
|------|------|---------|------------|--------------|-----------|---------------|-----------|
| MSK | 10 | Users | 192.168.10.254 | R12 | 192.168.10.252 | R13 | 192.168.10.253 |
| MSK | 99 | Management | 10.255.1.254 | R12 | 10.255.1.252 | R13 | 10.255.1.253 |
| SPB | 20 | Users | 192.168.20.254 | R16 | 192.168.20.252 | R17 | 192.168.20.253 |
| SPB | 99 | Management | 10.255.2.254 | R16 | 10.255.2.252 | R17 | 10.255.2.253 |
